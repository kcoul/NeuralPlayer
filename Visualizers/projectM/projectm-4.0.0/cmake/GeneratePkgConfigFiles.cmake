macro(GENERATE_PKG_CONFIG_FILES target package_name)
    ...
    if(UNIX)
        ...
        configure_file(${CMAKE_SOURCE_DIR}/Visualizers/projectM/projectm-4.0.0/cmake/pkgconfig-file.in "${CMAKE_CURRENT_BINARY_DIR}/${package_name}.pc" @ONLY)
        ...
        configure_file(${CMAKE_SOURCE_DIR}/Visualizers/projectM/projectm-4.0.0/cmake/pkgconfig-file.in "${CMAKE_CURRENT_BINARY_DIR}/${package_name}-debug.pc" @ONLY)
